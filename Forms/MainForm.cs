...
namespace OoTMMTracker.Forms
{
    public class MainForm : Form
    {
        ...
        private void InitializeComponent()
        {
            ...
            var leftPanel = new Panel { Dock = DockStyle.Left, Width = 430, BackColor = Color.FromArgb(30, 30, 30) };
            ...
            leftPanel.Controls.Add(_trackerScrollPanel);
            RebuildTracker();
        ...
        private void LoadSpoilerLog(string filePath)
        {
            try
            {
                ...
                _lblInfo.Text = $"Loaded: {_spoilerLog.Version} | Seed: {seedPreview} | Locations: {_spoilerLog.Locations.Count} | Entrances: {_spoilerLog.Entrances.Count}";
