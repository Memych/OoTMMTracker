...
namespace OoTMMTracker.Models
{
    ...
    public class TrackerConfig
    {
        ...
        /// <summary>Deep copy of this config.</summary>
        public TrackerConfig Clone()
        {
            var copy = (TrackerConfig)MemberwiseClone();
            copy.SrPouchPacks    = new List<string>(SrPouchPacks);
            copy.MqDungeons      = new List<string>(MqDungeons);
            copy.KeyRingDungeons = new List<string>(KeyRingDungeons);
            copy.GanonBk         = GanonBk?.Clone() ?? new GanonBkConditions();
            return copy;
        }
    ...
    public class GanonBkConditions
    {
        ...
        public GanonBkConditions Clone() => (GanonBkConditions)MemberwiseClone();
    }
}
