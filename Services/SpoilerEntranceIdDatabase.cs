// Auto-built: all keys from OoTMM data/defs/entrances.yml
// https://github.com/OoTMM/OoTMM/blob/master/data/defs/entrances.yml
// UNION parenthetical tokens from Entrances in spoiler logs from feedback/*.txt
// Regenerate: powershell -File tools/RegenerateSpoilerEntranceIdDatabaseFromUpstream.ps1
using System;
using System.Collections.Generic;

namespace OoTMMTracker.Services
{
    /// <summary>Canonical OoTMM entrance ids (upstream <c>entrances.yml</c>) plus any ids seen only in sampled spoilers.</summary>
    public static class SpoilerEntranceIdDatabase
    {
        ...
        /// <summary>True if this id is defined upstream or appeared in a sampled spoiler Entrances section.</summary>
        public static bool IsKnownId(string? id) =>
            !string.IsNullOrEmpty(id) && Ids.Contains(EntranceMapNavigation.NormalizeEntranceIdToken(id));

        public static int KnownIdCount => Ids.Count;

        public static IEnumerable<string> GetKnownIds() => Ids;
    }
}
