...
namespace OoTMMTracker.Services
{
    public static class TrackerItemsData
    {
        ...
        private static TrackerItem MakeDungeon(string id, string name, string labelIcon, bool rewardShuffle = false)
        {
            ...
            return new()
            {
                ...
                IconPath = labelIcon,
                RewardIcons = showReward ? AllRewardIcons : null,
                RewardNames = showReward ? AllRewardNames : null,
            };
        }
        ...
        public static List<TrackerItem> GetDungeonSingle(string id, string name, string label, TrackerConfig cfg)
        {
            ...
            if (hasReward && !cfg.DungeonRewardShuffle)
                items.Add(MakeDungeon(id, name, label, false));
