            ...
            mapRegion.SubRegions = new List<MapSubRegion>
            {
                new MapSubRegion
                {
                    ...
                    Marks = new List<MapMark>
                    {
                        ...
                        ME("Entrance.png", 451, 563, "Entrance shuffle (Fire Temple)", "OOT_DEATH_CRATER_FROM_TEMPLE_FIRE"),
            ...
            mapRegion.SubRegions = new List<MapSubRegion>
            {
                new MapSubRegion
                {
                    ...
                    Marks = new List<MapMark>
                    {
                        ...
                        ME("Entrance.png", 335, 239, "Entrance shuffle (Carpenter Tent)", "OOT_VALLEY_TENT"),
                        ME("Entrance.png", 296, 148, "Entrance shuffle (Song of Storms Grotto)", "OOT_GROTTO_SCRUBS2_VALLEY"),
            ...
            mapRegion.SubRegions = new List<MapSubRegion>
            {
                new MapSubRegion
                {
                    ...
                    Marks = new List<MapMark>
                    {
                        ...
                        ME("Entrance.png", 510, 425, "Entrance shuffle (Bazaar)", "OOT_KAKARIKO_BAZAAR"),
                        ME("Entrance.png", 398, 224, "Entrance shuffle (Shooting Gallery Adult)", "OOT_ADULT_ARCHERY"),
                        ...
                        ME("Entrance.png", 360, 424, "Entrance shuffle (Potion Shop Back)", "OOT_SHOP_POTION_KAKARIKO_BACK"),
        ...
        private static MapRegion KokiriForest()
        {
            ...
            mapRegion.SubRegions = new List<MapSubRegion>
            {
                ...
                new MapSubRegion
                {
                    ...
                    DestinationEntranceIds = new List<string> { "OOT_HOUSE_LINK" },
                    Marks = new List<MapMark>
                    {
            ...
            mapRegion.SubRegions = new List<MapSubRegion>
            {
                new MapSubRegion
                {
                    ...
                    Marks = new List<MapMark>
                    {
						...
						ME("Entrance.png", 356, 147, "Entrance shuffle (JP Climb Left Grotto)", "MM_GROTTO_EXIT_JP_CLIMB_LEFT"),
						MENJ("Entrance.png", 733, 74, "Entrance shuffle (Bean Grotto)", "Deku Palace", "MM_GROTTO_EXIT_BEAN"),
						MEJ("Entrance.png", 596, 1, "Entrance shuffle (Bean Grotto)", "Deku Palace", "MM_GROTTO_EXIT_BEAN"),
						ME("Entrance.png", 539, 2, "Entrance shuffle (JP Line End Grotto)", "MM_GROTTO_EXIT_JP_LINE_END"),
						ME("Entrance.png", 392, 53, "Entrance shuffle (Deku King Chamber Cage)", "MM_DEKU_PALACE_EXTERIOR_FROM_THRONE_CAGE"),
						ME("Entrance.png", 465, 163, "Entrance shuffle (Deku King Chamber)", "MM_DEKU_PALACE_EXTERIOR_FROM_THRONE"),
						ME("Entrance.png", 52, 2, "Entrance shuffle (Deku Shrine)", "MM_DEKU_PALACE_EXTERIOR_FROM_SHRINE"),
						ME("Entrance.png", 235, 10, "Entrance shuffle (JP Line Start Grotto)", "MM_GROTTO_EXIT_JP_LINE_START"),
						ME("Entrance.png", 570, 147, "Entrance shuffle (JP Climb Right Grotto)", "MM_GROTTO_EXIT_JP_CLIMB_RIGHT"),
            ...
            mapRegion.SubRegions = new List<MapSubRegion>
            {
                new MapSubRegion
                {
                    ...
                    Marks = new List<MapMark>
                    {
						...
						ME("Entrance.png", 1393, 1677, "Entrance shuffle (Swamp Gossip Stone Grotto)", "MM_GROTTO_GOSSIPS_SWAMP"),
						ME("Entrance.png", 1547, 282, "Entrance shuffle (Mountain Gossip Stone Grotto)", "MM_GROTTO_GOSSIPS_MOUNTAIN"),
						ME("Entrance.png", 960, 607, "Entrance shuffle (Ocean Gossip Stone Grotto)", "MM_GROTTO_GOSSIPS_OCEAN"),
						ME("Entrance.png", 2281, 771, "Entrance shuffle (Canyon Gossip Stone Grotto)", "MM_GROTTO_GOSSIPS_CANYON")
                    }
                },
                new MapSubRegion
                {
