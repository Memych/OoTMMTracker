        ...
        private static MapRegion DeathMountainCrater()
        {
            ...
            mapRegion.SubRegions = new List<MapSubRegion>
            {
                ...
                new MapSubRegion
                {
                    ...
                    Marks = new List<MapMark> { M("NPC.png", 482, 329, 40, "OOT Great Fairy Magic Upgrade 2", "Great Fairy Magic Upgrade 2") }
                }
            };
            return mapRegion;
        }
        ...
        private static MapRegion DeathMountainTrail()
        {
            ...
            mapRegion.SubRegions = new List<MapSubRegion>
            {
                ...
                new MapSubRegion
                {
                    Name = "Great Fairy Fountain",
                    BackgroundImage = OoT("Fairy", "Great_Fairy"),
                    Marks = new List<MapMark> { M("NPC.png", 482, 329, 40, "OOT Great Fairy Magic Upgrade", "Great Fairy Magic Upgrade") }
                }
            };
            return mapRegion;
        }
        ...
        private static MapRegion DesertColossus()
        {
            ...
            mapRegion.SubRegions = new List<MapSubRegion>
            {
                ...
                new MapSubRegion
                {
                    Name = "Great Fairy Fountain",
                    BackgroundImage = OoT("Fairy", "Great_Fairy"),
                    Marks = new List<MapMark> { M("NPC.png", 482, 329, 40, "OOT Great Fairy Nayru's Love", "Great Fairy Nayru's Love") }
                }
            };
            return mapRegion;
        }
        ...
        private static MapRegion Graveyard()
        {
            ...
            mapRegion.SubRegions = new List<MapSubRegion>
            {
                ...
                new MapSubRegion
                {
                    ...
                    Marks = new List<MapMark> { M("Chest.png", 453, 472, 40, "OOT Graveyard ReDead Tomb", "Graveyard ReDead Tomb") }
                },
                new MapSubRegion
                {
        ...
        private static MapRegion HyruleField()
        {
            ...
            mapRegion.SubRegions = new List<MapSubRegion>
            {
                ...
                new MapSubRegion
                {
                    ...
                    Marks = new List<MapMark> { M("Gold_Skulltula.png", 784, 149, 40, "OOT Hyrule Field Grotto Near Kakariko GS", "Hyrule Field Grotto Near Kakariko GS") }
                },
                new MapSubRegion
                {
                ...
                new MapSubRegion
                {
                    ...
                    Marks = new List<MapMark> { M("Collectible.png", 706, 238, 40, "OOT Hyrule Field Grotto Tektite HP", "Hyrule Field Grotto Tektite HP") }
                },
                new MapSubRegion
                {
                    Name = "Fairy Fountain",
        ...
        private static MapRegion Kakariko()
        {
            ...
            mapRegion.SubRegions = new List<MapSubRegion>
            {
                ...
                new MapSubRegion
                {
                    ...
                    Marks = new List<MapMark> { M("NPC.png", 606, 337, 40, "OOT Shooting Gallery Adult", "Shooting Gallery Adult") }
                },
                new MapSubRegion
                {
                    Name = "Windmill",
                ...
                new MapSubRegion
                {
                    ...
                    Marks = new List<MapMark> { M("Chest.png", 679, 261, 40, "OOT Kakariko Grotto Front", "Kakariko Grotto Front") }
                }
            };
            return mapRegion;
        }
            ...
            mapRegion.SubRegions = new List<MapSubRegion>
            {
                new MapSubRegion
                {
                    ...
                    Marks = new List<MapMark>
                    {
                        ...
                        M("Fairy_Spot", 2347, 1467, 40, "OOT Lost Woods Pool Big Fairy", "Lost Woods Pool Big Fairy"),
        ...
        private static MapRegion Market()
        {
            ...
            mapRegion.SubRegions = new List<MapSubRegion>
            {
                ...
                new MapSubRegion
                {
                    ...
                    Marks = new List<MapMark> { M("NPC.png", 606, 337, 40, "OOT Shooting Gallery Child", "Shooting Gallery Child") }
                },
                new MapSubRegion
                {
                    Name = "Dog Lady House",
        ...
        public static MapRegion SacredForestMeadow()
        {
            ...
            mapRegion.SubRegions = new List<MapSubRegion>
            {
                ...
                new MapSubRegion
                {
                    ...
                    Marks = new List<MapMark> { M("Chest.png", 661, 287, 40, "OOT Sacred Meadow Grotto", "Sacred Meadow Grotto") }
                },
                new MapSubRegion
                {
                    Name = "Fairy Fountain",
        ...
        public static MapRegion ZoraFountain()
        {
            ...
            mapRegion.SubRegions = new List<MapSubRegion>
            {
                ...
                new MapSubRegion
                {
                    Name = "Great Fairy Fountain",
                    BackgroundImage = OoT("Fairy", "Great_Fairy"),
                    Marks = new List<MapMark> { M("NPC.png", 482, 329, 40, "OOT Great Fairy Farore's Wind", "Great Fairy Farore's Wind") }
                }
            };
            return mapRegion;
        }
        ...
        private static MapRegion ClockTown()
        {
            ...
            mapRegion.SubRegions = new List<MapSubRegion>
            {
                ...
                new MapSubRegion
                {
                    ...
                    Marks = new List<MapMark> { M("NPC.png", 212, 169, 40, "MM Post Office HP", "Post Office HP") }
                },
                new MapSubRegion
                {
                    Name = "Lottery",
                ...
                new MapSubRegion
                {
                    ...
                    Marks = new List<MapMark> { M("NPC.png", 212, 425, 40, "MM Chest Game HP", "Chest Game HP") }
                },
                new MapSubRegion
                {
                    Name = "Honey & Darling",
        ...
        private static MapRegion DekuPalace()
        {
            ...
            mapRegion.SubRegions = new List<MapSubRegion>
            {
                ...
                new MapSubRegion
                {
                    ...
                    Marks = new List<MapMark> { M("NPC.png", 159, 291, 40, "MM Deku Palace Sonata of Awakening", "Deku Palace Sonata of Awakening") }
                },
                new MapSubRegion
                {
                    Name = "Deku Shrine",
        ...
        public static MapRegion IkanaCanyon()
        {
            ...
            mapRegion.SubRegions = new List<MapSubRegion>
            {
                ...
                new MapSubRegion
                {
                    ...
                    Marks = new List<MapMark> { M("NPC.png", 454, 146, 40, "MM Ghost Hut HP", "Ghost Hut HP") }
                },
                new MapSubRegion
                {
                    Name = "Music Box House",
                    BackgroundImage = MM("Ikana_Canyon", "Music_Box_House"),
                    Marks = new List<MapMark> { M("NPC.png", 677, 420, 40, "MM Music Box House Gibdo Mask", "Music Box House Gibdo Mask") }
                },
                new MapSubRegion
                {
                ...
                new MapSubRegion
                {
                    ...
                    Marks = new List<MapMark> { M("NPC.png", 440, 171, 40, "MM Ikana Great Fairy", "Ikana Great Fairy") }
                }
            };
            return mapRegion;
        }
        ...
        public static MapRegion MountainVillage()
        {
            ...
            mapRegion.SubRegions = new List<MapSubRegion>
            {
                ...
                new MapSubRegion
                {
                    ...
                    Marks = new List<MapMark> { M("NPC.png", 455, 271, 40, "MM Goron Graveyard Mask", "Goron Graveyard Mask") }
                },
                new MapSubRegion
                {
                    Name = "Generic Grotto",
        ...
        public static MapRegion Snowhead()
        {
            ...
            mapRegion.SubRegions = new List<MapSubRegion>
            {
                ...
                new MapSubRegion
                {
                    ...
                    Marks = new List<MapMark> { M("NPC.png", 458, 151, 40, "MM Snowhead Great Fairy", "Snowhead Great Fairy") }
                }
            };
            return mapRegion;
        }
        ...
        public static MapRegion TerminaField()
        {
            ...
            mapRegion.SubRegions = new List<MapSubRegion>
            {
                ...
                new MapSubRegion
                {
                    ...
                    Marks = new List<MapMark> { M("Chest.png", 631, 381, 40, "MM Termina Field Dodongo Grotto", "Termina Field Dodongo Grotto") }
                },
                new MapSubRegion
                {
                ...
                new MapSubRegion
                {
                    ...
                    Marks = new List<MapMark> { M("NPC.png", 509, 539, 40, "MM Termina Field Gossip Stones HP", "Termina Field Gossip Stones HP") }
                },
                new MapSubRegion
                {
                    Name = "Mountain Gossip Stone Grotto",
                    BackgroundImage = MM("Termina", "Mountain_Gossip"),
                    Marks = new List<MapMark> { M("NPC.png", 464, 553, 40, "MM Termina Field Gossip Stones HP", "Termina Field Gossip Stones HP") }
                },
                new MapSubRegion
                {
        ...
        public static MapRegion TwinIslands()
        {
            ...
            mapRegion.SubRegions = new List<MapSubRegion>
            {
                ...
                new MapSubRegion
                {
                    ...
                    Marks = new List<MapMark> { M("Chest.png", 140, 416, 40, "MM Twin Islands Frozen Grotto Chest", "Twin Islands Frozen Grotto Chest") }
                },
                new MapSubRegion
                {
                    Name = "Ramp Grotto",
        ...
        public static MapRegion Woodfall()
        {
            ...
            mapRegion.SubRegions = new List<MapSubRegion>
            {
                ...
                new MapSubRegion
                {
                    ...
                    Marks = new List<MapMark> { M("NPC.png", 457, 136, 40, "MM Woodfall Great Fairy", "Woodfall Great Fairy") }
                }
            };
            return mapRegion;
        }
        ...
        public static MapRegion ZoraCape()
        {
            ...
            mapRegion.SubRegions = new List<MapSubRegion>
            {
                ...
                new MapSubRegion
                {
                    ...
                    Marks = new List<MapMark> { M("NPC.png", 470, 169, 40, "MM Great Bay Great Fairy", "Great Bay Great Fairy") }
                }
            };
            return mapRegion;
        }
        ...
        public static MapRegion ZoraHall()
        {
            ...
            mapRegion.SubRegions = new List<MapSubRegion>
            {
                new MapSubRegion
                {
                    ...
                    Marks = new List<MapMark> { M("NPC.png", 492, 201, 40, "MM Zora Hall Scene Lights", "Zora Hall Scene Lights") }
                },
                new MapSubRegion
                {
                    Name = "Shop",
                ...
                new MapSubRegion
                {
                    ...
                    Marks = new List<MapMark> { M("NPC.png", 389, 395, 40, "MM Zora Hall Evan HP", "Zora Hall Evan HP") }
                },
                new MapSubRegion
                {
                    Name = "Lulu Room",
		...
		public static MapRegion InvertedStoneTowerTemple()
        {
            ...
            mapRegion.SubRegions = new List<MapSubRegion>
            {
				...
				new MapSubRegion
                {
                    ...
                    Marks = new List<MapMark>
                    {
						M("Chest.png", 466, 288, 40, "MM Stone Tower Temple Inverted Boss Key", "Stone Tower Temple Inverted Boss Key"),
